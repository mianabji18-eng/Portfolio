            ...
            <div className="container max-w-4xl mx-auto text-center z-10">
                <div className="space-y-6">
                    ...
                    <p className="text-lg md:text-xl text-muted-foregroud max-2-2xl max-auto opacity-0 animate-fade-in-delay-3">
                        I´m motivated to learn from new professional challenges
                        and provide innovative solutions, combining my technical skills 
                        with assertive communication and teamwork.
                    </p>
